fun main () {
    ...
    val secondNumber = readln().toInt()
        if (firstNumber == theFirstWinningNumber && secondNumber == theSecondWinningNumber || firstNumber == theSecondWinningNumber && secondNumber == firstNumber) println("Поздравляем! Вы выиграли главный приз!")
